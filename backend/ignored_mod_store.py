...
_ALLOWED_ROOTS = {
    ...
    "palschema": {"palschema_classic", "palschema_nested"},
}
...
class IgnoredIdentity:
    kind: Literal["pak", "logicpak", "ue4ss", "palschema"]
    root: Literal[
        "tilde_mods", "logic_mods", "ue4ss_classic", "ue4ss_nested",
        "palschema_classic", "palschema_nested",
    ]
    key: str
